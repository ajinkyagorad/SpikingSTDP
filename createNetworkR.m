%% Create reservoir network for Liquid State Machine (LSM) based on given positions R
...
function [X,Xn,T,W,R,E]= createNetworkR(R,w,r0,k0,f_inhibit,tau,show)
if(nargin<1) R = rand(100,3); end
...
fprintf("Reservoir with given position of %s neurons created %i/%i \r\n",mat2str(N),length(X),length(E));
